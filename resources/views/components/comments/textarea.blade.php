<div class="mt-6 flex gap-x-3">
    <img src="https://images.unsplash.com/photo-1550525811-e5869dd03032?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" class="h-6 w-6 flex-none rounded-full bg-gray-50">
    <form action="#" method="post" class="relative flex-auto">
        @csrf
        <div class="overflow-hidden rounded-lg pb-12 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
            ...
            <input type="hidden" name="announce_id" id="announce_id" value="">
        </div>
