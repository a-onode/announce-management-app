<div class="flex flex-shrink-0 self-center">
    <div class="relative inline-block text-left">
        <div>
            <button wire:click="$toggle('isVisible')" type="button" class="-m-2 flex items-center rounded-full p-2 text-gray-400 hover:text-gray-600" id="menu-0-button" aria-expanded="false" aria-haspopup="true">
        ...
        @if ($isVisible)
            <div wire:click="hidden()" class="fixed top-0 left-0 w-full h-full bg-opacity-100 flex items-center justify-center"></div>
